...
export default function Footer() {
  ...
  useEffect(() => {
    const fetchContactInfo = async () => {
      try {
        ...
        if (docSnap.exists()) {
          setContactInfo(docSnap.data() as typeof contactInfo);
        }
      } catch (err) {
  ...
  return (
    <footer className="relative z-50 bg-[#1a1a1a]/80 backdrop-blur-xl border-t border-white/[0.05]">
      <div
        className="footer"
        style={{
              ...
              <div style={{ border: "", display: "flex", flexFlow: "column" }}>
                ...
                >
                  ...
                  >
                    ...
                    />
                    <a
                      href={`tel:${contactInfo.landlines[0]}`}
                      className="ghost"
                      style={{ background: "rgba(100 100 100/ 40%)" }}
                    >
                      {contactInfo.landlines[0]}
                    </a>
                    Tel :
                    <a
                      href={`tel:${contactInfo.landlines[1]}`}
                      className="ghost"
                      style={{ background: "rgba(100 100 100/ 40%)" }}
                    >
                      {"26701633"}
